...
public class ActivityAIService {
    ...
    private Recommendation processAiResponse(Activity activity,String aiResponse){
        try{
            ...
            e.printStackTrace();
            return  createDefaultReccomendation(activity);

        }
    }

    private Recommendation createDefaultReccomendation(Activity activity) {
        return Recommendation.builder()
                .activityId(activity.getId())
                ...
                .improvements(Collections.singletonList("Conitnue with your current routine"))
                .userId(activity.getUserId())
    ...
    private List<String> extractSafetyGuideLines(JsonNode safetyNode){
        ...
        return safetyNode.isEmpty()?Collections.singletonList("Follow general safety guidelines"):safetyGuidelines;
    }
    ...
    private String createPromptActivity(Activity activity) {
        return String.format("""
                    Analyse this fitness activity and provide detailed recommendations in this given format
                    {
                        "analysis":{
                            "overall":"Overall analysis here",
                            "pace":"Pace analysis here",
                            "heartRate" : "Heart analysis here",
                        ...
                        Ensure the response follows the exact exact JSON format shown above.  
                        """,
